    ...
    <div class="modal-dialog  modal-xl" style="min-width: 1000px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('update.announcement', $announcement->id)}}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-2" style="display:flex; flex-direction:column;">
                            ...
                            <input type="date" value="{{$announcement->start_date}}" class="form-control" name="announcement_update_start" id="announcement_update_start" required>
                        </div>

                        
                        <div class="col-md-2" style="display:flex; flex-direction:column;">
                            <label for="announcement_update_end">End date</label>
                            <input type="date" value="{{$announcement->end_date}}" class="form-control" name="announcement_update_end" id="announcement_update_end" required>
                        </div>

                        <div class="col-md-4" style="display:flex; flex-direction:column;">
                            <label for="announcement_update_image">Image</label>
                            <input type="file" class="form-control" name="announcement_update_image" id="announcement_update_image" >
                        </div>
                  </div>
